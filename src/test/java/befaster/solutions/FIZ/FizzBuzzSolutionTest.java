...
public class FizzBuzzSolutionTest {
    ...
    public void compute_hello() {
        ...
        assertThat(fizzBuzz.fizzBuzz(237), equalTo("fizz fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(2265), equalTo("fizz buzz fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(3), equalTo("fizz fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(33), equalTo("fizz fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(30), equalTo("fizz buzz deluxe"));
        assertThat(fizzBuzz.fizzBuzz(43), equalTo("fizz"));
        assertThat(fizzBuzz.fizzBuzz(45), equalTo("fizz buzz fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(465), equalTo("fizz buzz fake deluxe"));
        ...
        assertThat(fizzBuzz.fizzBuzz(546), equalTo("fizz buzz deluxe"));
        assertThat(fizzBuzz.fizzBuzz(563), equalTo("fizz buzz fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(577), equalTo("buzz"));
        assertThat(fizzBuzz.fizzBuzz(593), equalTo("fizz buzz fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(600), equalTo("fizz buzz deluxe"));
        assertThat(fizzBuzz.fizzBuzz(653), equalTo("fizz buzz fake deluxe"));
        ...
        assertThat(fizzBuzz.fizzBuzz(1758), equalTo("fizz buzz deluxe"));
