...
public class FizzBuzzSolutionTest {
    ...
    public void compute_hello() {
        ...
        assertThat(fizzBuzz.fizzBuzz(15), equalTo("fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(151), equalTo("buzz"));
        assertThat(fizzBuzz.fizzBuzz(153), equalTo("fake deluxe"));
        ...
        assertThat(fizzBuzz.fizzBuzz(2265), equalTo("fake deluxe"));
        ...
        assertThat(fizzBuzz.fizzBuzz(45), equalTo("fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(465), equalTo("fake deluxe"));
        assertThat(fizzBuzz.fizzBuzz(5), equalTo("fake deluxe"));
